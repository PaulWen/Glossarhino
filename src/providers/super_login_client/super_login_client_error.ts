...
/////////////////////////////////////////////Constants/////////////////////////////////////////////
  ...
  public static get AUTH_ERR_1(): string {
    return "Email already in use";
  };

  public static get AUTH_ERR_2(): string {
    return "Password must be at least 6 characters";
  };

  public static get AUTH_ERR_3(): string {
    return "Email can't be blank";
  };

  public static get AUTH_ERR_4(): string {
    return "Password can't be blank";
  };

  public static get AUTH_ERR_5(): string {
    return "Name can't be blank";
  };

  public static get AUTH_ERR_6(): string {
    return "Email invalid email";
  };

  public static get LOGIN_ERR_1(): string {
    return "Invalid username or password";
  };

  public static get LOGIN_ERR_2(): string {
